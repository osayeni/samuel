...
step3 = importlib.import_module("tml-solutions.myawesometmlprojectnew-00f8.tml_read_gRPC_step_3_kafka_producetotopic_dag-myawesometmlprojectnew-00f8")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-myawesometmlprojectnew-00f8",
